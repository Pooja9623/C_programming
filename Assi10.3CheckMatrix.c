/* 1.check matrix is symmetric 
   2.display trace of matrix
   3.check matrix is upper triangular
   4.check matrix is lower triagular
...
int is_symmetric(int a[][20], int n)
{
	int i,j;
	for(i=0; i<n; i++)
	{
